...
<html>
    ...
    <body>
        ...
        <div class="col-md-9">
            ...
            <form:form action="${pageContext.request.contextPath}/product/edit?id=${product.productId}" modelAttribute="formEditProduct" method="post">
                    <table class="table">
                        <tr>
                            <td width="14%" height="20">Tên sản phẩm<font color="#FF0000">*</font></td>
                            <td width="75%"><form:input path="productName" type="text" style="width:500px; height:35px;"  placeholder="Tên sản phẩm" value="${product.productName}"/></td>
                        </tr>
                        <tr>
                            <td width="14%" height="20">Mô tả<font color="#FF0000">*</font></td>
                            <td width="75%"><form:input path="productDetail" type="text" style="width:500px; height:35px;" placeholder="Mô tả sản phẩm" value="${product.productDetail}"/></td>
                        </tr>
                        <tr>
                            <td width="14%" height="20">Giá<font color="#FF0000">*</font></td>
                            <td width="75%"><form:input path="productPrice" type="number" style="width:500px; height:35px;" placeholder="Giá sản phẩm" value="${product.productPrice}"/></td>
                        </tr>
                        <tr>
