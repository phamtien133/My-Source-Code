...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	function openmanager() {
		...
		win = editor.windowManager.open({
			title: title,
			file: editor.settings.external_filemanager_path+'dialog.php?type=4&descending='+descending+sort_by+fldr+'&lang='+editor.settings.language+'&akey='+akey + '&sid=' + session_id,
			width: 860,
			height: 570,
			inline: 1,
			resizable: true,
