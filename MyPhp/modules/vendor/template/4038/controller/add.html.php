...
?>
    ...
    <?= Core::getPhrase('language_da-tao-thiet-lap-thanh-cong')?>.<br />
     ...
     <form class="box style width100">
         <button onclick="window.location = './vendor/add/'" type="button"><span class="round"><span><?= Core::getPhrase('language_them')?></span></span></button><button class="fright" type="button" onclick="window.location = './vendor/index/'"><span class="round"><span><?= Core::getPhrase('language_quan-ly')?></span></span></button>
     </form>
    <?php else :?>
...
<table class="zebra">
    <tr>
        ...
        <td><input type="text" id="ten" name="ten" value="<?= $data['name']?>" /></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" id="ma_ten" name="ma_ten" value="<?= $data['name_code']?>" onblur="kiem_tra_ma_ten()" /></td>
    </tr>
...
<hr />
                ...
                <hr />
                <br clear="all" />
<button type="submit" name="submit"><span class="round"><span><?= Core::getPhrase('language_hoan-tat')?></span></span></button><button class="fright" type="button" onclick="window.location = './vendor/index/'"><span class="round"><span><?= Core::getPhrase('language_quan-ly')?></span></span></button>
    </form>
