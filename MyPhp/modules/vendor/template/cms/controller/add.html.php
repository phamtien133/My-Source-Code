    ...
    <section class="grid-block"><div class="grid-box grid-h">
        <div class="module mod-box">
            <div class="content-box panel-shadow">
                ...
                <? elseif($this->_aVars['aData']['data']['status'] == 3):?>
                    ...
                    <div class="row30 padtop10">
                        ...
                        <div class="col3 padright10">
                            <div class="button-blue" onclick="window.location='/vendor/';">
                ...
                <form action="#" method="post" name="frm_dang_ky" id="frm_add" class="box style width100" onsubmit="return sbm_frm()">
                    ...
                    <div class="row30 line-bottom padbot10 mgbt10">
                        <div class="col3"><label for="ten" class="sub-black-title" style="width: 50px"><?= Core::getPhrase('language_ten')?>:</label><span id="div_ten_kiem_tra_ma_ten"></span></div>
                        <div class="col9"><input type="text" id="ten" name="name" value="<?= $this->_aVars['aData']['data']['list']['name'] ?>" class="default-input"/></div>
                    </div>
                    <div class="row30 line-bottom padbot10 mgbt10">
                        ...
                        <div class="col9"><input type="text" id="ma_ten" name="name_code" value="<?= $this->_aVars['aData']['data']['list']['name_code']?>" onblur="kiem_tra_ma_ten()" class="default-input"/></div>
                    </div>
                    <div class="row30 line-bottom padbot10 mgbt10">
                        <div class="col3">
                            <label for="duong_dan_hinh_' + slide + '" class="sub-black-title left">
                                <?= Core::getPhrase('language_hinh-dai-dien')?>
                            </label>
                        </div>
                        <div class="col9">
                            <div class="col10 padright10">
                                <input type="text" name="image_path" id="image_path" value="<?= $this->_aVars['aData']['data']['list']['image_path']?>" class="inputbox text-input default-input"/>    
                            </div>
                            <div class="col2 row30">
                                <div class="button-blue" type="button" onclick="opHinhAnh()">
                    ...
                    <div class="row30 line-bottom padbot10 mgbt10">
                        <div class="col3">
                            <label for="description" class="sub-black-title left">
                                <?= Core::getPhrase('language_mo-ta')?>
                            </label>
                        </div>
                        <div class="col9">
                            <textarea style="width:100%" name="description" id="description" class="default-input"><?= $this->_aVars['aData']['data']['list']['description']?></textarea>
                        </div>
                    </div>
                    <div class="row30 line-bottom padbot10 mgbt10">
                        <div class="col3"><label for="hotline" class="sub-black-title"><?= Core::getPhrase('language_so-dien-thoai')?>:</label></div>
                        <div class="col9"><input type="text" id="hotline" name="hotline" value="<?= $this->_aVars['aData']['data']['list']['hotline']?>" class="default-input"/></div>
                    </div>
                    <div class="row30 line-bottom padbot10 mgbt10">
                        <div class="col4">
                            <div class="col4"><label for="hotline" class="sub-black-title">Tỉnh/Thành:</label></div>
                            <div class="col7 padlr10">
                                <select name="city" id="js-select-city" style="height: 30px; width:100%">
                                    <option value="-1">Chọn Tỉnh/Thành</option>
                                    <? foreach ($this->_aVars['aData']['data']['areas']['city'] as $aVals):?>
                                     <option value="<?= $aVals['id']?>" <? if ($this->_aVars['aData']['data']['list']['city'] == $aVals['id'] ):?> selected="selected"<? endif?>><?= $aVals['name']?></option>
                                    <? endforeach?>
                                </select>
                            </div>
                            <div class="col1">
                        ...
                        <div class="col4">
                            <div class="col4"><label for="hotline" class="sub-black-title">Quận/Huyện:</label></div>
                            <div class="col7 padlr10">
                                <select name="district" id="js-select-district" style="height: 30px; width:100%">
                                    <option value="-1">Chọn Quận/Huyện</option>
                                    <? foreach ($this->_aVars['aData']['data']['areas']['district'] as $aVals):?>
                                     <option value="<?= $aVals['id']?>" <? if ($this->_aVars['aData']['data']['list']['district'] == $aVals['id'] ):?> selected="selected"<? endif?>><?= $aVals['name']?></option>
                                    <? endforeach?>
                                </select>
                            </div>
                            <div class="col1">
                        ...
                        <div class="col4">
                            <div class="col4"><label for="hotline" class="sub-black-title">Phường/Xã:</label></div>
                            <div class="col7 padlr10">
                                <select name="ward" id="js-select-ward" style="height: 30px; width:100%">
                                    <option value="-1">Chọn Phường/Xã</option>
                                    <? foreach ($this->_aVars['aData']['data']['areas']['ward'] as $aVals):?>
                                     <option value="<?= $aVals['id']?>" <? if ($this->_aVars['aData']['data']['list']['ward'] == $aVals['id'] ):?> selected="selected"<? endif?>><?= $aVals['name']?></option>
                                    <? endforeach?>
                                </select>
                            </div>
                            <div class="col1">
                    ...
                    <div class="row30 line-bottom padbot10 mgbt10">
                        <div class="col3"><label for="hotline" class="sub-black-title">Số nhà - Tên đường</div>
                        <div class="col9"><input type="text" id="street" name="street" value="<?= $this->_aVars['aData']['data']['list']['street']?>" class="default-input"/></div>
                    </div>
                    <div class="row30 line-bottom  padbot10 mgbt10">
                        <div class="col3">
                        ...
                        <div class="col9">
                            <select name="status" id="trang_thai" style="height: 30px; width:100%">
                    ...
                    <div class="row30 mgbt10">
                        <div class="col3">
                            <input type="checkbox" name="extend" id="extend" onchange="changeExtend(this);" <? if($extend == 1):?> checked<? endif?> />
                                <label class="sub-black-title" style="margin-left: 10px; width: auto; margin-top: 9px; cursor: pointer" for="extend">Mở rộng</label>
                        </div>
                    </div>
                    <div id="danh_sach_chi_tiet" class="row30" style="display: none; width: 960px">
                            <div class="row30 mgbt10">
                                <div class="col3">
                                    <label for="found_time" class="sub-black-title">Thời gian thành lập:</label>
                                </div>
                                <div class="col9">
                                    <input type="text" value="<?= $this->_aVars['aData']['data']['list']['found_time']?>" name="found_time" class="js-date-time tt tt2 default-input" id="found_time">
                                </div>
                            </div>
                            <div class="row30 mgbt10">
                                <div class="col3">
                                    <label for="found_time" class="sub-black-title">Giờ mở cửa:</label>
                                </div>
                                <div class="col9">
                                    <input type="number" value="<?= $this->_aVars['aData']['data']['list']['open_hour']?>" name="open_hour" class="default-input">
                                </div>
                            </div>
                            <div class="row30">
                                <div class="col3">
                                    <label for="found_time" class="sub-black-title">Giờ đóng cửa:</label>
                                </div>
                                <div class="col9">
                                    <input type="number" value="<?= $this->_aVars['aData']['data']['list']['close_hour']?>" name="close_hour" class="default-input">
                                </div>
                            </div>
                    </div>
                    <hr />
                    <div class="row30"> 
                        ...
                        <div class="col10"></div>
                        <div class="col1">
                            <div class="button-blue" onclick="window.location = '/vendor/index/'">
                                <?= Core::getPhrase('language_quan-ly')?>
                            </div>
                        </div>
                    </div>
                ...
                <div id="dialog_search_box">
                    <input type="hidden" id="stt_bai_lien_ket_lien_quan" value="0" />
                    <input type="hidden" id="class_bai_lien_ket_lien_quan" value="0" />
                    <div style="background:#FFF;border:1px solid #CCC;width:370px;padding-left:5px;height:30px">
                        <input type="text" id="txt_user_lien_quan" value="" style="border:0;width:300px" onkeydown="return tim_bai_lien_quan_dem_nguoc(event, 'user')" onblur="tim_bai_lien_quan('user')">
                        <a href="javascript:" onclick="return tim_bai_lien_quan('user')" title="<?= Core::getPhrase('language_tim-bai-lien-quan')?>"><img src="//<?= Core::getDomainName()?>:8888/static/global/images/search.png"></a> <a href="javascript:" onclick="return xoa_bai_lien_quan('user')" title="<?= Core::getPhrase('language_xoa')?>"><img src="//<?= Core::getDomainName()?>:8888/static/global/images/delete.png"></a>
                        <div id="div_tim_user_lien_quan"></div>
                    </div>
                </div>
...
function tim_bai_lien_quan(obj) {
    ...
    function xu_ly_tim_bai_lien_quan(obj, tu_khoa, data)
    {
        ...
        if(obj == 'user')
        {
            ...
            {
                tmp = dong[i].split('<->');
                noi_dung += '<tr><td><a>' + tmp[1] + '</a></td><td align="center"><img src="//<?= Core::getDomainName()?>:8888/static/global/images/openid/' + tmp[2] + '.png" width="20" /></td><td><div id="txt_them_' + obj + '_lien_quan_canh_bao" style="display:none"><img src="//<?= Core::getDomainName()?>:8888/static/global/images/status_yes.png" title="<?= Core::getPhrase('language_da-chon')?>" /></div><div id="txt_them_' + obj + '_lien_quan"><a href="javascript:" onClick="return chon_thanh_vien(' + tmp[0] + ', \'' + tmp[1] + '\')"><?= Core::getPhrase('language_chon')?></a></div></td></tr>';
            }
        }
        else if(obj == 'youtube')
        {
            ...
            {
                tmp = dong[i].split('<->');
                noi_dung += '<tr><td><img src="http://img.youtube.com/vi/' + tmp[0] + '/2.jpg" /></td><td><div id="txt_them_' + obj + '_lien_quan_canh_bao" style="display:none"><img src="//<?= Core::getDomainName()?>:8888/static/global/images/status_yes.png" title="<?= Core::getPhrase('language_da-them')?>" /></div><div id="txt_them_' + obj + '_lien_quan"><a href="http://www.youtube.com/watch?v=' + tmp[0] + '" target="_blank">' + tmp[1] + '</a></div></td><td><td><a href="" onClick="return chen_youtube(\'' + tmp[0] + '\')"><?= Core::getPhrase('language_them')?></a></td></tr>';
            }
        }
        ...
        else if(obj == 'bai_lien_ket')
        {
            for( var i=0;i<tong;i++)
            {
                ...
                noi_dung += '<tr><td><a href="' + tmp[1] + '" target="_blank">' + tmp[2] + '</a></td><td><div id="txt_them_' + obj + '_lien_quan_canh_bao" style="display:none"><img src="//<?= Core::getDomainName()?>:8888/static/global/images/status_yes.png" title="<?= Core::getPhrase('language_da-them')?>" /></div><div id="txt_them_' + obj + '_lien_quan"><a href="javascript:" class="simplemodal-close" onClick="return chon_lien_ket(\'' + tmp[0] + '\', \'' + tmp_lk[1] + '\', \'' + tmp_lk[2] + '\')"><?= Core::getPhrase('language_chon')?></a></div></td></tr>';
            }
        }
        else
        {
            for( var i=0;i<tong;i++)
            {
                ...
                tmp_lk[1] = tmp_lk[1].replace(/"/g, '&quot;');
                noi_dung += '<tr><td><a href="' + tmp[0] + '" target="_blank">' + tmp[1] + '</a></td><td><div id="txt_them_' + obj + '_lien_quan_canh_bao" style="display:none"><img src="//<?= Core::getDomainName()?>:8888/static/global/images/status_yes.png" title="<?= Core::getPhrase('language_da-them')?>" /></div><div id="txt_them_' + obj + '_lien_quan"><a href="javascript:" onClick="return chen_lien_ket(\'' + tmp_lk[0] + '\', \'' + tmp_lk[1] + '\')"><?= Core::getPhrase('language_them')?></a></div></td></tr>';
            }
        }
        if(tong == 0)
        {
    ...
    {
        document.getElementById('div_tim_' + obj + '_lien_quan').innerHTML = '<img src="//<?= Core::getDomainName()?>:8888/static/global/images/waiting.gif"> <?= Core::getPhrase('language_dang-sinh-khoa-vui-long-doi')?>';
...
var hinh_slide_hien_tai = 0;
    ...
    function upHinhMoRong(arr) {
        ...
        function receiveMessage(e) {
            if (e.origin !== '//' + global['domain'] + ':8888') return;
    ...
    moPopup(document.location.protocol + '//' + global['domain'] + ':8888/dialog.php?type=1&field_id=' + arr.obj +'&height=' + arr.height + '&width=' + arr.width + '&sid=<?= session_id()?>',
        function(){
    ...
    for(i in arr['ten'])
    {
        ...
        content += '<div class="div_menu div_con div_menu_nhom_0" id="div_slide_' + slide + '"><div style="float:right"> \
                <a href="javascript:" onclick="return tang_giam_vi_tri(0, ' + slide + ', 1)">\
                    <img src="//<?= Core::getDomainName()?>:8888/styles/acp/img/up.png" />\
                </a>\
...
function lay_ma_ten_tu_dong(noi_dung, obj)
{
    ...
    if(obj == 'ma_ten' && ma_ten_truoc != noi_dung)
    {
        ...
        if(obj_ten.innerHTML != '<img src="//<?= Core::getDomainName()?>:8888/static/global/images/waiting.gif">' )
        {
            obj_ten.innerHTML = '<img src="//<?= Core::getDomainName()?>:8888/static/global/images/waiting.gif">';
        }
    }
}
    ...
    if(ma_ten_truoc != noi_dung)
    {
        ...
        http.onreadystatechange = function () {
            if(http.readyState == 4){
                ...
                {
                    obj_ten.innerHTML = '<img src="//<?= Core::getDomainName()?>:8888/static/global/images/status_no.png">';
                }
                else
                {
                    obj_ten.innerHTML = '<img src="//<?= Core::getDomainName()?>:8888/static/global/images/status_yes.png">';
                }
            }
        };
