...
<p class="buttonarea"><button type="button" onclick="window.location='/filter/general/add/';"><span class="round"><span><?= Core::getPhrase('language_them')?></span></span></button></p>
