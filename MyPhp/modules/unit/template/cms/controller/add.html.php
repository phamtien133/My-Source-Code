                    ...
                    <div class="content-box panel-shadow">
                        ...
                        <?php elseif($status == 3):?>
                            ...
                            <div class="row30 padtop10">
                                <div class="col3 padright10">
                                    <div class="button-blue" onclick="window.location='/unit/add/';">
                                        <?= Core::getPhrase('language_them')?>
                                    </div>
                                </div>
                                <div class="col3 padright10">
                                    <div class="button-blue" onclick="window.location='/unit/';">
                        ...
                        <form action="#" method="post" name="frm_dang_ky" id="frm_add" class="box style width100" onsubmit="return sbm_frm()">
                            ...
                            <div class="row30 line-bottom padbot10 mgbt10">
                                ...
                                <div class="col7">
                                    <textarea style="width:100%" name="description" id="description" class="default-input"><?= $data['description']?></textarea>
                                </div>
                            </div>
...
function kiem_tra_ma_ten() {
    ...
    if(ma_ten_truoc != noi_dung)
    {
        ...
        http.send('val[id]=<?= $id?>&val[type]=unit&val[name_code]='+unescape(noi_dung));
    }
}
