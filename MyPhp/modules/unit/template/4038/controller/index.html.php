...
<tr id="tr_shop_custom_<?= $shop_custom['id'][$i]?>">
    ...
    <td><a href="/vendor/edit/?id=<?= $shop_custom['id'][$i]?>"><?= $shop_custom['name'][$i]?></a></td>
    ...
    <td><a href="/vendor/edit/?id=<?= $shop_custom['id'][$i]?>" title="<?= Core::getPhrase('language_sua-bai')?>"><img src="http://img.<?= Core::getDomainName()?>/styles/web/global/images/edit.png" alt="<?= Core::getPhrase('language_sua-bai')?>" /></a></td>
...
<p class="buttonarea"><button type="button" onclick="window.location='./vendor/add/';"><span class="round"><span><?= Core::getPhrase('language_them')?></span></span></button></p>
...
?>
   ...
   <p class="buttonarea"><button type="button" onclick="window.location='./';"><span class="round"><span><?= Core::getPhrase('language_trang-quan-tri')?></span></span></button></p>
<?php
}
?>