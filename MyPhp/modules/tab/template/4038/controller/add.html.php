...
?>
    ...
    <?= Core::getPhrase('language_da-tao-thiet-lap-thanh-cong')?>.<br />
     ...
     <form class="box style width100">
         <button onclick="window.location = './tab/add/'" type="button"><span class="round"><span><?= Core::getPhrase('language_them')?></span></span></button><button class="fright" type="button" onclick="window.location = './tab/'"><span class="round"><span><?= Core::getPhrase('language_quan-ly')?></span></span></button>
     </form>
    <?php else :?>
...
<table class="zebra">
    ...
    <tr>
     ...
     <tfoot>
     	<tr><td colspan="2"><button type="submit" name="submit"><span class="round"><span><?= Core::getPhrase('language_hoan-tat')?></span></span></button><button class="fright" type="button" onclick="window.location = './tab/'"><span class="round"><span><?= Core::getPhrase('language_quan-ly')?></span></span></button></td></tr>
	</tfoot>
</table>
    </div>
