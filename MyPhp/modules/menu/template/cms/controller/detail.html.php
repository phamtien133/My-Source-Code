                        ...
                        <?php if ($status == 2): ?>
                            <form id="jForm" action="#" method="post" onsubmit="return submit_frm_dang_cau_hoi()">
                                ...
                                <div class="row30 line-bottom padbot10 mgbt10">
                                    ...
                                    <div class="col7">
                                        <input type="text" name="name" id="name" value="<?= $ten?>" class="inputbox default-input" style="width:100%" onblur="dem_so_ky_tu(this.value.length, 0, this.id);" />
                                    </div>
                                </div>
                                <div class="row30 line-bottom padbot10 mgbt10">
                                    <div class="col5">
                                        <label for="ten" class="sub-black-title" style="width: 100%">
                                ...
                                <div class="row30 line-bottom padbot10 mgbt10">
                                    ...
                                    <div class="col7">
                                        <select id="page_type" name="page_type" style="height: 30px; width:100%">
                                            <? foreach ($this->_aVars['aPageType'] as $sKey => $sValue): ?>
                                            <option value="<?= $sKey ?>" <? if ($page_type == $sKey): ?>selected="selected" <? endif;?>><?= $sValue ?></option>
                                            <? endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row30 line-bottom padbot10 mgbt10">
                                    ...
                                    <div class="col7">
                                        <input type="text" name="path" id="path" value="<?= $duong_dan?>" class="inputbox default-input" style="width:100%" />
                                ...
                                <div class="row30 line-bottom padbot10 mgbt10">
                                    ...
                                    <div class="col7">
                                        <div class="col10 padright10">
                                            <input type="text" name="image_path" id="image_path" value="<?= $duong_dan_hinh?>" class="inputbox text-input default-input" />
                                        </div>
                                ...
                                <div class="row30 line-bottom padbot10 mgbt10">
                                    ...
                                    <div class="col7">
                                        <select name="status" id="status" style="height: 30px; width:100%" class="inputbox">
                                    ...
                                    <div id="tabs-4">
                                        <div>
                                            ...
                                            <?= Core::getPhrase('language_khach')?>
                                             ...
                                             <option value="3" <?php if($quyen == 3):?>selected="selected"<?php endif?>>
                                             Onwer
                                            </option>
                                            </select>
                                        </div>
                        ...
                        <?php elseif($status == 3):?>
                            ...
                            <div class="row30 padtop10">
                                <div class="col3 padright10">
                                    <div class="button-blue" onclick="window.location='/menu/detail/?mid=<?= $mid?>&sub=<?= $cha_stt?>';">
                                        <?= Core::getPhrase('language_tao-menu')?>
                                    </div>
                                </div>
                                <div class="col3 padright10">
                                    <div class="button-blue" onclick="window.location='/menu/list/id_<?= $mid?>';">
                            ...
                            {
                                window.location = '/menu/list/id_<?= $mid?>';
                            }
                            </script>
                        <?php else:?>
                            <?php if(!empty($errors)):?>
