            ...
            <div class="grid-box grid-h">
                <div class="module mod-box">
                    <div class="content-box panel-shadow">
                        ...
                        <?php elseif($status == 3):?>
                            ...
                            <div class="row30 padtop10">
                                <div class="col3 padright10">
                                    <div class="button-blue" onclick="window.location='/area/add/';">
                                        <?= Core::getPhrase('language_them')?>
                                    </div>
                                </div>
                                <div class="col3 padright10">
                                    <div class="button-blue" onclick="window.location='/area/';">
                        ...
                        <?php else :?>
                        <form action="#" method="post" name="frm_dang_ky" class="box style width100" id="frm_add" onsubmit="return sbm_frm()">
                            <?php if(!empty($errors)):?>
                                <div class="row30 padtb10 ">
                                    <?= Core::getPhrase('language_da-co-loi-xay-ra')?>            
                                </div>
                            ...
                            <div class="row30 line-bottom padbot10 mgbt10">
                                ...
                                <div class="col7">
                                    <select name="parent_id" id="parent_id" class="inputbox" style="height: 30px; width:100%">
                                        <option value="-1">Chọn khu vực cha</option>
                                        <?php for($i=0;$i<count($aAreas);$i++):?>
                                        <option data-parentid="<?= $aAreas[$i]['parent_id']?>" value="<?= $aAreas[$i][0]?>"<?php if($data['parent_id'] == $aAreas[$i][0]) {?> selected="selected"<?php }?>>
                                        <?= $aAreas[$i][1]?>
                                        </option>
                                        <?php endfor?>
                                    </select>
                            ...
                            <div class="row30 line-bottom padbot10 mgbt10">
                                ...
                                <div class="col7">
                                    <input type="text" id="ten" name="name" value="<?= $data['name']?>" class="default-input"/>
                                </div>
                            </div>
                            <div class="row30 line-bottom padbot10 mgbt10">
                                <div class="col5">
                                    <label for="ma_ten" class="sub-black-title">
                                ...
                                <div class="col7">
                                    <input type="text" id="ma_ten" name="name_code" value="<?= $data['name_code']?>" onblur="kiem_tra_ma_ten()" class="default-input"/>
                                </div>
                            </div>
                    ...
                    <div id="dialog_search_box">
                        ...
                        <div style="background:#FFF;border:1px solid #CCC;width:370px;padding-left:5px;height:30px">
                                                ...
                                                <a href="javascript:" onclick="return tim_bai_lien_quan('user')" title="<?= Core::getPhrase('language_tim-bai-lien-quan')?>"><img src="http://img.<?= Core::getDomainName()?>/styles/acp/img/search.png"></a> <a href="javascript:" onclick="return xoa_bai_lien_quan('user')" title="<?= Core::getPhrase('language_xoa')?>"><img src="http://img.<?= Core::getDomainName()?>/styles/acp/img/delete.png"></a>
                    ...
                    function kiem_tra_ma_ten() {
                        ...
                        if(ma_ten_truoc != noi_dung)
                        {
                            ...
                            http.send('val[id]=<?= $id?>&val[type]=area&val[pid]=' + pid + '&val[name_code]='+unescape(noi_dung));
                        }
                    }
