...
<section class="container product unselectable page-list-vendor">
    <section class="sanpham fthtab">
        ...
        <section class="product-list-box content-box panel-shadow mgbt20" ng-class="showlist">
            ...
            <? endif?>
            <!-- Phân trang -->
            <?= Core::getService('core.tools')->paginate(ceil($this->_aVars['aData']['data']['total']/$this->_aVars['aData']['data']['page_size']), $this->_aVars['aData']['data']['page'], '/imageextend/?'.'&page=::PAGE::', '/imageextend/?', '', '')?>
